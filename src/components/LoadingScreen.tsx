  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-[#020202] text-white relative overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center gap-12 text-center px-6">
        ...
        >
            <img 
                ...
                className="h-28 w-auto object-contain mb-6 transition-all duration-700" 
                alt="VOZ"
            ...
            <p className="text-gray-600 mt-4 text-xs font-bold tracking-[0.4em] uppercase">Premium Entertainment Protocol</p>
        </motion.div>
      ...
      <div className="absolute bottom-12 flex flex-col items-center gap-2">
          <p className="text-[10px] text-gray-700 font-black tracking-[0.3em] uppercase">© 2026 VOZ PROTOCOL • DUBAI DXB</p>
          <div className="h-0.5 w-12 bg-primary-600/30 rounded-full" />
      </div>
    </div>
  );
}
